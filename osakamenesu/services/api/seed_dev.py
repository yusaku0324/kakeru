...
# Local therapist images generated by nanobanana AI
THERAPIST_AVATARS = [
    "/images/sample-therapist-aoi.png",
    "/images/sample-therapist-mao.png",
    "/images/sample-therapist-rin.png",
]
...
def main(argv: list[str]) -> int:
    ...
    for i in range(args.count):
        ...
        primary_staff = {
            "name": name,
            "alias": "指名No.1",
            "avatar_url": THERAPIST_AVATARS[i % len(THERAPIST_AVATARS)],
        ...
        contact_json = {
            ...
            "staff": [
                primary_staff,
                {
                    ...
                    "alias": "新人",
                    "avatar_url": THERAPIST_AVATARS[(i + 1) % len(THERAPIST_AVATARS)],
                ...
                },
                {
                    ...
                    "alias": "ムードメーカー",
                    "avatar_url": THERAPIST_AVATARS[(i + 2) % len(THERAPIST_AVATARS)],
        ...
        diary_entries = [
            {
                ...
                "photos": [f"/images/demo-shop-{(idx % 3) + 1}.svg"],
        ...
        for t_idx, t_name in enumerate(therapist_names_for_shop):
            therapist_payload = {
                ...
                "name": t_name,
                "age": 22 + (t_idx * 2) + (i % 5),
                "photo_url": THERAPIST_AVATARS[
                    (i * 3 + t_idx) % len(THERAPIST_AVATARS)
                ],
                "tags": rng.sample(
                    [
                        "オイル",
