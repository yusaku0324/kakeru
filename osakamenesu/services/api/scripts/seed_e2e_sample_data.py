        ...
        "staff": [
            {
                "name": "葵",
                "alias": "指名No.1",
                "avatar_url": THERAPIST_AVATARS[0],  # aoi
            ...
            },
            {
                "name": "凛",
                "alias": "新人",
                "avatar_url": THERAPIST_AVATARS[2],  # rin
            ...
            },
            {
                "name": "真央",
                "alias": "ムードメーカー",
                "avatar_url": THERAPIST_AVATARS[1],  # mao
            ...
            },
            {
                "name": "桜",
                "alias": "技術派",
                "avatar_url": THERAPIST_AVATARS[0],
            ...
            },
            {
                "name": "紬",
                "alias": "癒し系",
                "avatar_url": THERAPIST_AVATARS[1],
    ...
    },
    {
        ...
        "staff": [
            ...
            },
            {
                "name": "楓",
                "alias": "人気上昇中",
                "avatar_url": THERAPIST_AVATARS[2],
