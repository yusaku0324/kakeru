...
import type { ShopFavoriteRecord, ShopFavoritesContextValue, ShopFavoriteApiResponse } from '../domain/types'
  ...
  useEffect(() => {
    ...
    async function loadFavorites() {
      ...
      try {
        ...
        const data = (await res.json()) as ShopFavoriteApiResponse[]
