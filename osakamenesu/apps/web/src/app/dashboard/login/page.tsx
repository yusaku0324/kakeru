    ...
    <main className="mx-auto max-w-4xl space-y-10 px-6 py-16">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)]">
        <Card className="space-y-6 border-brand-primary/30 bg-white/90 p-6 shadow-lg shadow-brand-primary/10">
          ...
          <div className="rounded-2xl border border-dashed border-brand-primary/30 bg-brand-primary/5 px-4 py-3 text-sm text-brand-primaryDark">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="space-y-4 p-6">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-3 text-sm text-neutral-700">
            <p className="font-semibold">サポート窓口</p>
            <p>support@osakamenesu.com</p>
