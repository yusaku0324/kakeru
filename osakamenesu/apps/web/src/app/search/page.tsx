          ...
          <div className="relative z-10 mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2 sm:gap-6 lg:mt-12">
              <Link
                ...
                className="group relative flex flex-col items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 px-6 py-8 text-white shadow-[0_20px_60px_rgba(37,99,235,0.4)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_25px_70px_rgba(37,99,235,0.5)] sm:py-10"
              >
                ...
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(99,102,241,0.3),transparent_50%)]" />
                <svg className="mb-3 h-10 w-10 drop-shadow-lg sm:h-12 sm:w-12" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                </svg>
                <span className="text-lg font-bold drop-shadow-sm sm:text-xl">本日予約できる</span>
                <span className="text-lg font-bold drop-shadow-sm sm:text-xl">セラピストを見る</span>
                <span className="mt-3 inline-flex items-center gap-1 rounded-full bg-white/20 px-4 py-1.5 text-sm font-semibold text-white backdrop-blur-sm transition-all group-hover:bg-white/30">
                  今すぐチェック
