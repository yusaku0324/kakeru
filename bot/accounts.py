"""
Account management module for bot
"""
import os
import logging
...
CONFIG_PATH = Path(__file__).parent.parent / "kakeru" / "config" / "accounts.yaml"
SHADOWBAN_CONFIG_PATH = Path(__file__).parent.parent / "kakeru" / "config" / "shadowban.yaml"
